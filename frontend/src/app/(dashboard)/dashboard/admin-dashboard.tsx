...
export function AdminDashboard() {
	...
	const ongoing =
		data.theses.by_status.find((s) => s.status === "ONGOING")?.count ?? 0;
                      ...
                      con số và danh sách không thể lệch nhau. */}
									<Link
										...
										<span
											...
											style={{
												color:
													t === "danger" ? "var(--danger)" : "var(--warning)",
											}}>
							...
							{data.recent_errors.map((e, i) => (
								<li
									...
									<div className="flex items-center gap-2">
										<code className="text-[11.5px] font-mono text-danger">
											{e.action}
										</code>
									...
									{e.message && (
										<p className="text-[12px] text-tertiary mt-0.5 line-clamp-2">
											{e.message}
										</p>
									)}
									{e.actor && (
