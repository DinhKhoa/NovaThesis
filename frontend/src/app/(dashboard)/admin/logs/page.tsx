...
const levelBadges: Record<LogLevel, { label: string; variant: "info" | "warning" | "danger" }> = {
...
export default function AdminLogsPage() {
  ...
  const filterKey = JSON.stringify([debouncedSearch, levelFilter, actionFilter, from, to]);
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Lịch sử đăng nhập và thao tác trên dữ liệu, phục vụ kiểm toán. Nhật ký là dữ liệu chỉ đọc: không thể sửa hoặc xóa từ giao diện."
      />
          ...
          <Table
            ...
            columns={[
              ...
              },
              {
                ...
                sortValue: (l) => l.level,
                render: (l) => (
                  <Badge variant={levelBadges[l.level].variant}>{l.level}</Badge>
                ),
              },
              {
                key: "action",
              ...
              },
              {
                ...
                render: (l) => (
                  <span className="text-[13px] text-secondary">{l.user_email}</span>
                ),
              },
              {
                key: "ip_address",
        ...
        {selectedLog && (
          <div className="flex flex-col gap-3 text-[13px]">
            ...
            <div>
              ...
              <span className="font-mono text-secondary">{selectedLog.ip_address ?? "—"}</span>
            </div>
            <div>
              <span className="text-tertiary block mb-1">Thiết bị (User agent):</span>
