 ...
 * DỮ LIỆU MẪU
 *
 * Mục tiêu: sau `npm run db:seed`, đăng nhập vào là có ngay một đề tài đang
 * chạy, mốc tiến độ ở đủ 5 trạng thái, tài liệu THẬT để trợ lý AI trích dẫn
 * được, và ba vai trò để thử phân quyền.
 *
